...
$app->post('/api/MicrosoftTranslatorText/getLanguagesForTranslate', function ($request, $response) {
    ...
    $query_str = "https://api.microsofttranslator.com/V2/Http.svc/GetLanguagesForTranslate";
