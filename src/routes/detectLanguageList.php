...
$app->post('/api/MicrosoftTranslatorText/detectLanguageList', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','textList']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','textList'=>'textList'];
    $optionalParams = [];
    $bodyParams = [
    ];
    ...
    $query_str = "https://api.microsofttranslator.com/V2/Http.svc/DetectArray";
