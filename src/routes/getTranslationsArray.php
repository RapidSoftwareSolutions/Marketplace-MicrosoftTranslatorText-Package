...
$app->post('/api/MicrosoftTranslatorText/getTranslationsArray', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','maxTranslations','texts','to']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','maxTranslations'=>'MaxTranslations','texts'=>'Texts','to'=>'To'];
    $optionalParams = ['from'=>'From','category'=>'Category','contentType'=>'ContentType','profanityAction'=>'ProfanityAction','state'=>'State','uri'=>'Uri','user'=>'User','IncludeMultipleMTAlternatives'=>'IncludeMultipleMTAlternatives'];
    $bodyParams = [
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    $xmlElement = array('From','Options','Texts','To','MaxTranslations');
    $xmlOptions = array(
    ...
    $xml = new SimpleXMLElement('<GetTranslationsArrayRequest/>');
    $xml->addChild('AppId');
    ...
    $query_str = "https://api.microsofttranslator.com/V2/Http.svc/GetTranslationsArray";
