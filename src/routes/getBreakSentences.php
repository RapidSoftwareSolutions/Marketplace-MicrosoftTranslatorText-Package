...
$app->post('/api/MicrosoftTranslatorText/getBreakSentences', function ($request, $response) {
    ...
    $query_str = "https://api.microsofttranslator.com/V2/Http.svc/BreakSentences";
