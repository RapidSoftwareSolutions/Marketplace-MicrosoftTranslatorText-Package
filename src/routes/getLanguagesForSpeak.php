...
$app->post('/api/MicrosoftTranslatorText/getLanguagesForSpeak', function ($request, $response) {
    ...
    $query_str = "https://api.microsofttranslator.com/V2/Http.svc/GetLanguagesForSpeak";
