...
$app->post('/api/MicrosoftTranslatorText/detectLanguage', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'apiKey','text'=>'text'];
    $optionalParams = [];
    $bodyParams = [
       'query' => ['text']
    ];
    ...
    $query_str = "https://api.microsofttranslator.com/V2/Http.svc/Detect";
